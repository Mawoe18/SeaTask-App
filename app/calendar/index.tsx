...
import { Alert, View, Text, TouchableOpacity, FlatList, TextInput, StyleSheet } from 'react-native';
import { Calendar } from 'react-native-calendars';
import { useRouter } from 'expo-router';
import MaterialIcons from '@expo/vector-icons/MaterialIcons';
import EventModal from '../components/EventModal';
import ShareCalendarModal from '../components/ShareCalendarModal';
import { fetchHolidays, getEvents, saveEvent, updateEvent, deleteEvent, shareCalendar, importCalendar } from '../../src/services/calendarService';
import BottomSheet from '@gorhom/bottom-sheet';
import { addDays, addWeeks, addMonths, isAfter, isBefore, parseISO, formatISO } from 'date-fns';
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <BottomSheet
        ...
        onChange={(index) => {
          // Close modals when bottom sheet opens
          if (index >= 0) {
            if (showEventModal) setShowEventModal(false);
            if (showShareModal) setShowShareModal(false);
          }
